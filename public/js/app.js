...
var _Support = require('./components/Support.vue');
...
},{"./components/Layout.vue":30,"./components/Print.vue":31,"./components/Support.vue":32,"vue":27,"vue-resource":16}],30:[function(require,module,exports){
var __vueify_style__ = require("vueify-insert-css").insert("\n\n\nh3 {\n    font-size: 16px;\n    color: limegreen;\n    margin: 25px  0 15px 40px;\n}\np {\n    margin-left: 40px;\n\n}\n\n\n.jl-bpld {\n    font-weight: bolder;\n}\n\n.jl-panel {\n    /*width: 600px;*/\n    height: 500px;\n    padding: 10px;\n    border-radius: 0;\n    text-align:left;\n    background-color: #000000;\n\n    /*background: url('/images/jl-screen.gif');*/\n    /*background-size: cover;*/\n    /*background-repeat: no-repeat;*/\n}\n.jl-shadow {\n    box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);\n    /*box-shadow:10px 10px;*/\n}\n")
'use strict';

var _Print = require('./Print.vue');
...
module.exports = {
    ...
    components: { Print: _Print2.default },
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  var id = "/Users/jalawren/Desktop/laravel/resources/assets/js/components/Layout.vue"
...
},{"./Print.vue":31,"vue":27,"vue-hot-reload-api":2,"vueify-insert-css":28}],31:[function(require,module,exports){
var __vueify_style__ = require("vueify-insert-css").insert("\n\n\n\n")
'use strict';
...
module.exports = {
    ...
    methods: {
        ...
        setTimer: function setTimer() {
            ...
            this.timeout = Math.floor(Math.random() * 250) + 50;

            setTimeout(this.printOutput, this.timeout);
        },

        printOutput: function printOutput() {

            if (this.key < this.array.length) {

                this.message += this.array[this.key];
    ...
    ready: function ready() {
        ...
        setTimeout(this.printOutput, Number(this.time));
    }
};
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n\n<span class=\"jl-font\">{{ message }}</span>\n\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/jalawren/Desktop/laravel/resources/assets/js/components/Print.vue"
  module.hot.dispose(function () {
    require("vueify-insert-css").cache["\n\n\n\n"] = false
    document.head.removeChild(__vueify_style__)
  })
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/jalawren/Desktop/laravel/resources/assets/js/components/Support.vue"
  module.hot.dispose(function () {
    require("vueify-insert-css").cache["\n\n@font-face {\n    font-family: pressStart;\n    src: url(/fonts/PressStart2P-Regular.ttf);\n}\n\nli {\n    text-decoration: none;\n    display: block;\n\n}\n\n.jl-font {\n    font-family: \"pressStart\";\n\n}\n\n"] = false
    document.head.removeChild(__vueify_style__)
  })
